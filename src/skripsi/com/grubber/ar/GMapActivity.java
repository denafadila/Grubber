...
public class GMapActivity extends FragmentActivity implements LocationListener,
    GooglePlayServicesClient.ConnectionCallbacks,
    GooglePlayServicesClient.OnConnectionFailedListener {

  protected static final String TAG = GMapActivity.class.getSimpleName();
  ...
  public void getAddress(View v) {
    ...
    if (servicesConnected()) {
      ...
      (new GMapActivity.GetAddressTask(this)).execute(currentLocation);
    }
  }
