...
public class RestaurantActivity extends BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    LLCommentField = (LinearLayout) findViewById(R.id.comment_field);
    LLCommentField.setVisibility(View.INVISIBLE);
    ...
    tvRate.setText(Html.fromHtml("<i>" + numberToWords(activity.getStar()) + "</i>"));
    ...
    rAdapter = new CommentListAdapter(RestaurantActivity.this, mReviewResult);
