...
public class ProfileFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    /*
     * mLogOut = (Button) v.findViewById(R.id.btnLogOut); mLogOut.setOnClickListener(new
     * View.OnClickListener() {
     * 
     * @Override public void onClick(View v) { // TODO Auto-generated method stub
     * Log.d("LogOut Button", "Clicked"); ParseUser.logOut(); Intent i = new
     * Intent(getActivity().getBaseContext(), MainActivity.class); startActivity(i);
     * getActivity().finish();
     * 
     * } });
     * 
